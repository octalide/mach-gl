...
def gen_c(cmds):
    out = []
    out.append("# gl.c: raw loaded-pointer layer for the OpenGL core profile (generated).")
    out.append("#")
...
def gen_enums(enums):
    out = []
    out.append("# gl.enums: core OpenGL enumerant constants (generated).")
    out.append("#")
...
def gen_cmd(cmds):
    out = []
    out.append("# gl.cmd: idiomatic layer for the OpenGL core profile (generated).")
    out.append("#")
    ...
    for cn, ret, params in cmds:
        ...
        out.append("# {}: wraps {}.".format(snake(cn), cn))
        out.append(decl + " {")
        ...
        out.append("}")
    out.append("")
    out.append("# version: query the GL major and minor version. valid after load.")
    out.append("# ---")
...
def gen_gl(cmds, enums):
    out = []
    out.append("# gl.gl: the flat public surface of the OpenGL bindings (generated).")
    out.append("#")
